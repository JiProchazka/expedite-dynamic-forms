...
<template>
  ...
  >
    <div class="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 rounded-lg" :class="colorClasses">
      <svg
        class="w-5 h-5"
        aria-hidden="true"
    ...
    <div class="ms-3 text-sm font-normal mr-2">{{ message }}</div>
    <button
      @click="emit('close', id)"
      type="button"
